      ...
      <table width="100%" style="border: 1px solid black;font-size: 10px !important" >
        ...
        <?php 
          ...
          <tr style="border: 1px solid black;">
            ...
            <td width="15%" align="right" style="border: 1px solid black;"><b></b></td>
            <td width="15%" align="right" style="border: 1px solid black;"></td>
          </tr>   
          <tr style="border: 1px solid black;">
          ...
          <tr style="border: 1px solid black;">
            ...
            <td width="15%" align="right" style="border: 1px solid black;"></td>
               ...
               <!--  <tr style="border: 1px solid black;">
                ...
                <tr style="border: 1px solid black;">
                    <td style="border: 1px solid black;font-size: 10px;font-weight: bold;" colspan="5" align="right">VAT </td>
                    <td width="15%" align="right" style="border: 1px solid black;"><b></b></td>
                    <td width="15%" align="right" style="border: 1px solid black;"></td>
                </tr>
