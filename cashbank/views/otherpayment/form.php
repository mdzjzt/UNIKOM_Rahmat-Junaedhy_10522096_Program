	           	...
	           	<div class="col-md-6" >
	           		<table width="100%" class="table">
                         ...
                         <tr>
                            ...
                            <td>:</td>
                            <td>  
                                <?php echo form_textarea('memo_op',!empty($data->memo_op) ? $data->memo_op : '', 'class="form-control" id="memo_op"  cols="4" rows="4"'); ?>
                          ...
                          <tr>
                            ...
                            <td>:</td>
                            <td>  
                                <?php echo form_textarea('payee',!empty($data->payee) ? $data->payee : '', 'class="form-control" id="payee"  cols="4" rows="4"'); ?>
                ...
                <div class="col-md-6">
                    <table width="100%" class="table">
                         <tr>
                            ...
                            <td>:</td>
                            <td>  
                                <?php echo form_dropdown('id_coa_op', $coa_account_cash, !empty($data->id_coa_op) ? $data->id_coa_op : '', 'class="form-control select2" id="coa_account_cash"  '); ?>
                        ...
                        <tr>
                            ...
                            <td> <div class='input-group date' style="width: 50%">
                                    <?php echo form_input('date_op',!empty($data->date_op) ? $data->date_op : date('Y-m-d'), 'class="form-control " id="date_gl"') ?>
                        ...
                        <tr>
                            ...
                            <td>:</td>
                            <td>  
                                <?php echo form_input('cheque_no', !empty($data->cheque_no) ? $data->cheque_no : NULL, 'class="form-control" id="cheque_no"'); ?>
                          ...
                          <tr>
                            ...
                            <td>:</td>
                            <td>  
                                <?php echo form_input('amount_op', !empty($data->amount_op) ? $data->amount_op : NULL, 'class="form-control number"  id="amount_op"'); ?>
                        ...
                        <?php if($id){ 
                                ...
                                foreach($dtdetail->result() as $dt){ ?>
                                    ...
                                    <tr id="tr_lk_<?php echo $nodt++ ?>" class="lk_tr">
                                        ...
                                        <td class="text-center" >
                                            <?php echo form_input('ammount_detail[]',!empty($dt->debit_gl) ? $dt->debit_gl :NULL, 'class="form-control number debit" onkeyup="cekdebit(1)" id= "debit_'.$nodt1++.'" ') ?>
                                        </td>
