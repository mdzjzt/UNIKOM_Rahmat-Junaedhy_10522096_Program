...
<div class="modal-body">
    ...
    <fieldset>
        <div class="form-group">
            <label class="col-md-4 control-label">Kelompok Jabatan <sup>*</sup></label>
            <div class="col-md-8">
                    <?php echo form_input('kelompok_jabatan_nama', !empty($data_edit->kelompok_jabatan_nama) ? $data_edit->kelompok_jabatan_nama : '', 'class="form-control" data-rule-required="true"') ?>
            </div>
        </div>
