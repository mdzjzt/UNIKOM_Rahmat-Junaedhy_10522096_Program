  ...
  <div class="portlet light bordered">
    ...
    <div class="portlet-title">
        <form class="form-horizontal" id="filter-table">
            <div class="form-group form-group-sm">
                <label class="control-label col-md-2">Kode / Nama</label>
                <div class="col-md-5">
    ...
    <div class="portlet-body">
        <table id="dt-basic" 
            ...
            <thead>                         
                <tr>
                    <th class="text-center col-md-1" data-sorting="false">NO</th>
                    <th class="col-md-2">KODE</th>
                    <th class="col-md-4">NAMA</th>
                    <th class="col-md-4">ALAMAT</th>
                    <th class="col-md-4">TELEPON</th>
                    <th class="col-md-4">REKENING</th>
                    <th>KODE LOKASI</th>
