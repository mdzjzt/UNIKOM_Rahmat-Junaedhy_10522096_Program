        ...
        <form class="form-horizontal" id="filter-table">
         <!--    <div class="form-group form-group-sm">
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-md-4">
                     <?php echo form_dropdown('jabatan_id', $jabatan, '' ,'class="form-control select2"'); ?>
                </div>
            </div>
          <!--   <div class="form-group form-group-sm">
                <label class="col-md-2 control-label">Unit Kerja</label>
                <div class="col-md-4">
                     <?php // echo form_dropdown('unit_kerja_id', $unit, '' ,'class="form-control select2"'); ?>
                </div>
            </div> -->
            
            <div class="form-group form-group-sm">
                <label class="control-label col-md-2">NIK / Nama</label>
                <div class="col-md-5">
