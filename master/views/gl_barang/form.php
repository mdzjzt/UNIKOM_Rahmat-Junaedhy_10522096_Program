<div class="container">
  <ol class="breadcrumb" style="margin-bottom: 0px; left: -10px">
    <li><a href="<?php echo base_url() ?>">Home</a></li>
    <li><a href="<?php echo base_url() ?>#menu/index/utility">Master</a></li>
    <li><a href="<?php echo base_url() ?>#master/gl_barang">Golongan Barang</a></li>
