...
<body class="body">
    ...
    <!-- <htmlpageheader name="MyHeader"> -->
    	<div class="header">
			...
			<div class="kiri-2">
				<div style="font-weight: bold; font-size: 13px;">PT CITRA PANJI MANUNGGAL</div>
	    		<div style="padding-left: 0px;font-size: 12px;">Jl. Ciputat Raya No. 16, Kebayoran Lama Selatan,</div>
	    		<div style="padding-left: 0px;font-size: 12px;">Jakarta Selatan 12240, Indonesia</div>
	    		<div style="padding-left: 0px;font-size: 12px;">Ph: 021-7653723 <br>Fx: 021-7658806</div>
			...
			<div class="kanan">
				<div class="kanan-1">
					...
					<table  style="font-size: 12px;">
						<tr>
							<td valign="top">NAME OF PROJECT</td>
							<td valign="top">:</td>
							<td valign="top"><?php echo $data->nama_proyek ?></td>
						</tr>
						<div class="clear"></div>
						<tr>
							<td valign="top">REQUISITION NUMBER</td>
							<td valign="top">:</td>
							<td valign="top"><?php echo $data->kode_mr ?></td>
						</tr>
						<div class="clear"></div>
						...
						<tr>
							...
							<td valign="top">:</td>
							<td valign="top"><?php echo $data->tanggal_buat_mr ?></td>
						</tr>
					</table>
				...
				<div class="kanan-2">
					<div class="kanan-atas">
 							<img src="<?php echo $image[0]->file ?>" alt="..." width="100px;"> 
					</div>
				</div>
				
			</div>
			<div class="kanan-bawah" style="text-align: right;">MATERIAL REQUISITION</div>
    	</div>       
    <!-- </htmlpageheader> -->
	<div class="content">
		<table class="table" width="100%" style="font-size: 9px !important">
		      <thead>
		          <tr>
		              <th style="color: #000;text-align: left; border-bottom: hidden;padding: 2px 20px; font-weight: none;" colspan="5">EQUIPMENT OR MATERIAL GROUP <?php echo $data->nama_permintaan ?></th>
		              <th style="color: #000;text-align: left; border-bottom: hidden;padding: 2px 20px" colspan="4"></th>
		          </tr>
		          <tr>
		              <th style="color: #000;text-align: left;padding: 2px 20px; font-weight: none;" colspan="5">(GIVE MODEL & SERIAL NO)</th>
		              <th style="color: #000;text-align: center;padding: 2px 20px; font-weight: none;" colspan="4">THIS AREA FOR MATERIALSMAN USE ONLY</th>
		          </tr>
		          <tr>
		      ...
		      <?php $no=1; foreach ($table as $value) { ?>
		          <tr>
		          	  ...
		          	  <td style="color: #000" width="25%"><?php echo $value->description ?>
		          	  <br><?php echo $value->desc_detail ?>
		          	  <br><?php if (!empty($value->size )) {
		              ...
		              <td style="color: #000;text-align: center" width="8%"><?php echo $value->on_order ?></td>
		              <td style="color: #000;text-align: center"><?php echo $value->code_account ?></th>
		          </tr>
		      <?php } ?>
					<!-- <tr>
						<td style="color: #000;text-align: left; border-bottom: hidden;padding: 2px 20px;" colspan="5">NOTE :</td> -->
					<!-- 	<td style="color: #000;text-align: left; border-bottom: hidden;padding: 2px 20px" colspan="4"> --><!-- SPECIAL INTRUCTION --><!-- </td> -->
				<!-- 	</tr>
					<tr>
						<td style="color: #000;text-align: left;padding: 2px 20px" colspan="5"><?php// echo $data->note ?></td>
						<td style="color: #000;text-align: left;padding: 2px 20px" colspan="4"> --><!-- INDICATE IF CONFIRMING A PHONE OR RADIO ORDER -->
							
						<!-- </td>
					</tr>
					<tr>
						<td style="color: #000;text-align: left; border-bottom: hidden; border-top: hidden;padding: 2px 20px;" colspan="5"> --><!-- RECHARGE TO --><!-- </td>
						<td style="color: #000;text-align: left; border-bottom: hidden; border-top: hidden;padding: 2px 20px" colspan="4"></td>
					</tr>
					<tr>
						<td style="color: #000;text-align: left;padding: 2px 20px" colspan="5"> --><!-- OBTAIN COMPANY --><!-- </td>
						<td style="color: #000;text-align: left;border-bottom: hidden;padding: 2px 20px"  colspan="4" valign="top">
					...
					<tr>
						...
						<td  colspan="4" style="color: #000;text-align: left; border-bottom: hidden;border-top: hidden;padding: 2px 19px"> -->
							...
							<?php //if ($status_approve == 1) { ?>
								...
								<td>
									<table width="90%" class="tbl_ttd">
										...
										<tr><td><?php // $valuee->pegawai_nama ;?><br><?php// echo $valuee->jabatan_nama ?></td></tr>
									</table>
								</td>
							 <?php// } ?>
							<?php// } ?>
					...
					<tr>
						...
						<td style="color: #000;text-align: left;padding: 2px 20px" colspan="4"></td>
					</tr>
					<tr>
						...
						<!-- </td>
						<td style="color: #000;text-align: left;padding: 2px 20px;border-top: hidden;" colspan="4"> -->
						<!-- SHIPPING INTRUCTION
		...
		<br>
		<div class="note_bwh" style="font-size: 10px;">NOTE : <?php echo $data->note ?> </div>
		<div class="ttd_bwh">
						<table class="tbl-head-ttd" style="float: right;">
							<tr>
							<td >
								<table class="tbl_ttd" width="100%" style="margin-right: 10px;"> 
									<tr>
										<td style="font-size: 10px">REQUISITIONED BY</td>
										<td rowspan="2"> <img class="image-check" width="20px" src="<?php echo base_url() ?>assets/img/check-print.png"></td>
									</tr>
									<tr><td style="font-size: 10px"><?php echo $name_request->pegawai_nama ?><br><?php echo $name_request->nama_role ?></td></tr>
							...
							<!-- <?php // if ($status_approve == 1) { ?> -->
								<?php foreach ($data_app as $key => $valuee) { ?>
								<td>
									<table width="100%" class="tbl_ttd" style="float: right;">
										<tr>
											<td style="font-size: 10px">APPROVED BY</td>
											<td rowspan='2'><img width="20px" class="image-check" src="<?php echo base_url() ?>assets/img/check-print.png"></td>
										</tr>
										<tr><td style="font-size: 10px"><?php echo $valuee->pegawai_nama ;?><br><?php echo $valuee->jabatan_nama ?></td></tr>
									</table>
								</td>
						<!-- 	 <?php //} ?> -->
							<?php } ?>
