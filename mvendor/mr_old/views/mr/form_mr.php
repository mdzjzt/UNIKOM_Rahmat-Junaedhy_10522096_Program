 ...
 -->
              ...
              <label class="col-md-2 ">Tanggal MR</label>
               ...
               <?php if($site_project != 0){ ?>
                  <label class="col-md-3 " style="text-align: right;">Department Project  <sup>*</sup></label>
                <div class="col-md-3">
                     <?php echo form_dropdown('deparment', $department_project, !empty($department) ? $department : NULL, 'class="form-control select2"') ?>
                </div>
              <?php } ?>
    ...
    function remove_equipment_form(id, id_equipment) {
        ...
        bootbox.confirm("Anda yakin akan menghapus Field ini?", "Tidak", "Ya", function (e) {
            if (e) {
                  ...
                  if(id_equipment){
                       $.ajax({
                      url : "<?php echo base_url() ?>mr/mr/delete_mr_equipment/"+id_equipment,
                            type: "POST",
                            dataType: "JSON",
