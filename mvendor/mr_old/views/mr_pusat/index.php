  ...
  <div class="portlet light bordered">
    ...
    <div class="portlet-title">
      <form class="form-horizontal" id="filter-table">
        ...
        <div class="col-md-3">
          <?php echo form_input('keyword', NULL, 'class="form-control" placeholder="Department"'); ?>
        </div>
          <div class="col-md-2">
          <?php echo form_input('kode_projek', NULL, 'class="form-control" placeholder="Kode"'); ?>
        </div>
                 ...
                 data-table-filter="#filter-table">
                  <thead>                     
                      <tr>
                          ...
                          <th style="width:30px" >KODE AREA </th>
                          <th style="width:160px">CLIENT </th>
                     <!-- <th style="width:50px">TGL PEMBUATAN</th> -->
                          <th style="width:160px">INFO  MR</th>
