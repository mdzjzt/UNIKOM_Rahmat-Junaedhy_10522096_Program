...
<script type="text/javascript">
  ...
  var tbl_detail = $('#tbl_detail').DataTable({ 
    ...
    "paging" : true,
    "iDisplayLength": 10,
    "sAjaxSource": "mr/mr_pusat/detail/"+1,
    "aaSorting": [[ 2, "asc" ]],
   ...
   var tbl_info = $('#tbl_info').DataTable({ 
      ...
      var tbl_info_list_approve = $('#tbl_info_list_approve').DataTable({ 
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": "mr/mr_pusat/detail_info_list_approved/"+1+"/"+0,
            "type": "POST"
        },
  ...
  function detail_mr(id){
    ...
    tbl_detail.ajax.url("mr/mr_pusat/detail/"+id).load();
   ...
   function detail_info(id){
    ...
    $('#modalinfo').modal('show');
     tbl_info.ajax.url("mr/mr_pusat/detail_info/"+id).load();

  }

  function close_modal(){
     $('#modalDetail').modal('hide');
    tbl_detail.ajax.url("mr/mr_pusat/detail/0").load();

  }

  function close_modal_info(){
     $('#modalinfo').modal('hide');
    tbl_info.ajax.url("mr/mr_pusat/detail_info/0").load();
...
function list_approved(id_project,id_mr){
  ...
  tbl_info_list_approve.ajax.url("mr/mr_pusat/detail_info_list_approved/"+id_project+"/"+id_mr).load();
}

function close_modal_info_list(){
     $('#modallistapproved').modal('hide');
    tbl_info_list_approve.ajax.url("mr/mr_pusat/detail_info_list_approved/0/0").load();
