...
class mr_model extends CI_Model
{
    ...
    public function data_info_list_approve_new($id, $param = NULL,$dt = 0){
         if ($param == '2') {
             $flow = 'PRO-BID-01';
         }else if($param == '3'){
            $flow = 'PRO-PO-05';
        ...
        $this->db->select(" * from sys_workflow_detail a
                            ...
                            left join mrange_approval j on j.id_range = a.id_range
                            where a.workflow_id = '".$flow."' and a.project_id = '".$id."' and a.or_order = '0'
                            and a.department_flow = '0' or a.department_flow = '".$dt."'
                            ORDER BY a.flow_order ");
        return $this->db;
    }
    ...
    public function table_equipment($key=array())
    {
        ...
        // $this->db->join('m_account_code b', 'b.id_account_code = a.acc_no','left');
