    ...
    <div class="portlet-title" id="div-filter">
        <form class="form-horizontal" id="filter_table">
            ...
            <div class="form-group form-group-sm">
                <label class="control-label col-md-2">NAMA CURRENCY</label>
                <div class="col-md-5">
    ...
    <div class="portlet-title">
        <?php 
            if ($this->laccess->otoritas('add')) {           
               echo anchor(NULL, '<i class="glyphicon glyphicon-plus"></i> TAMBAH CURRENCY', array(
                                    'id'              => 'mybutton-add',
        ...
        <table id="dt_basic" 
            ...
            <thead>                         
                <tr>
                    ...
                    <th class="col-md-3">NAMA CURRENCY</th>
                    <th class="col-md-3">CURRENCY</th>
                    <th class="col-md-3">SIMBOL CURRENCY</th>
                    <th class="col-md-3">NEGARA</th>
                    <th>DESCRIPTION</th>
