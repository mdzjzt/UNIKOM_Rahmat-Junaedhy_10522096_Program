  ...
  <div class="modal-body">
      <table class="table table-consended">
          ...
          <tbody>
            <tr>
              <td>{pendahuluan}</td>
              <td>Data Pendahuluan Dasar Permintaan</td>
            </tr>
            <tr>
              <td>{latar_belakang}</td>
              <td>Data Latar Belakang Dasar Permintaan</td>
            </tr>
            <tr>
              <td>{tujuan}</td>
              <td>Data Tujuan Permintaan</td>
            </tr>
            <tr>
              <td>{definisi}</td>
              <td>Data Definisi tentang permintaan</td>
            </tr>
            <tr>
              <td>{jenis_permintaan}</td>
              <td>Title jenis permintaan (barang,jasa,lainnya)</td>
            </tr>
            <tr>
              <td>{list_permintaan}</td>
              <td>List Permintaan dengan item barang/jasa </td>
            </tr>
            <tr>
              <td>{ops_ruang_lingkup}</td>
              <td>Ruang lingkup permintaan </td>
            </tr>
            <tr>
              <td>{ops_tahapan}</td>
            ...
            <tr>
              <td>{cabang_nama}</td>
              <td>Nama Cabang tempat dimana dilakukan permintaan/pekerjaan </td>
            </tr>
            <tr>
              <td>{ops_jangka_waktu}</td>
              <td>jangka waktu pelaksanaan pekerjaan (ANGKA)</td>
            </tr>
            <tr>
              <td>{terbilang_ops_jangka_waktu}</td>
              <td>jangka waktu pelaksanaan pekerjaan secara terbilang</td>
            </tr>
            <tr>
              <td>{ops_bidang_usaha}</td>
              <td>Bidang usaha </td>
            </tr>
            <tr>
              <td>{ops_pengalaman}</td>
              <td>Pengalaman Kerja dalam tahun</td>
            </tr>
            <tr>
              <td>{terbilang_ops_pengalaman}</td>
              <td>Pengalaman Kerja dalam tahun secara terbilang </td>
            </tr>
          </tbody>
      </table>
  </div>
