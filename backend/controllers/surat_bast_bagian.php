...
class surat_bast_bagian extends MX_Controller
{
    ...
    {   
        if(hprotection::must_ajax($this->_module)):
            $data = $this->syssetings_model->data(['key_setting' => 'APP_CONFIG', 'name_setting' => 'default_bast_bagian'])->get()->row();
    ...
    public function save()
    {
        ...
        ->update(['key_setting' => 'APP_CONFIG', 'name_setting' => 'default_bast_bagian'],['value_setting' => $this->input->post('value_setting')]);
