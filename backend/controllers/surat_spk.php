...
class surat_spk extends MX_Controller
{
    ...
    {   
        if(hprotection::must_ajax($this->_module)):
            $data = $this->syssetings_model->data(['key_setting' => 'APP_CONFIG', 'name_setting' => 'default_spk'])->get()->row();
    ...
    public function save()
    {
        ...
        ->update(['key_setting' => 'APP_CONFIG', 'name_setting' => 'default_spk'],['value_setting' => $this->input->post('value_setting')]);
