...
class purchase_order_model extends CI_Model
{
   ...
   private $_table  = 'purchase_order_template';
    private $_table_1  = 'purchase_order_item';
    private $_table_2  = 'tbl_approve_purchase';
     private $_table_user  = 'm_user';

    private function _key($key,$alias = TRUE)
    {
        if(!is_array($key)):
            $primary_key = $alias ? 'a.id_po' : 'id_po';
    ...
    public function data($key = array(), $order_by = '', $direction = 'asc' , $limit = NULL, $offset = 0)
    {
        ...
        ->join($this->_table_user . ' b','b.id_user = a.create_by', 'left outer');
