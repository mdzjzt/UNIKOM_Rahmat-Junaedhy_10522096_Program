      ...
      <table width="100%" style="border: 1px solid black;font-size: 10px !important" >
        ...
        <?php $total += $value->total_price; } ?>
          ...
          <tr style="border: 1px solid black;">
            ...
            <td width="15%" align="right" style="border: 1px solid black;"><?php echo number_format($total,2); ?></td>
          </tr>   
          <tr style="border: 1px solid black;">
            <td style="border: 1px solid black;font-size: 10px;font-weight: bold;" colspan="6" align="right">
              <?php
                  if (!empty($data->discount_persen)) {
                    $persen = $data->discount_persen.'%';
                  }else{
                    $persen = '';
              }?>
              Discount <?php echo $persen ?> 
            </td>
            <td width="15%" align="right" style="border: 1px solid black;">
              <?php
                $discont = $data->diskon;  
                echo number_format($discont, 2);
              ?>
            </td>
          <tr style="border: 1px solid black;">
            ...
            <td width="15%" align="right" style="border: 1px solid black;">
              <?php
                 $discont = $data->diskon ;
                 $totaldiskon = $total - $discont;
                 $discount_amount = $data->vat ;
                 echo number_format($totaldiskon,2); 
               ?>   
            </td>
          </tr>
          <tr style="border: 1px solid black;">
            <td style="border: 1px solid black;font-size: 10px;font-weight: bold;" colspan="6" align="right">VAT <?php echo $data->vat; ?>%</td>
            <td width="15%" align="right" style="border: 1px solid black;"><?php

             $discont = $data->diskon ;
              $totaldiskon = $total - $diskon;
             $discount_amount = $data->vat ;
             $vat_nilai= $totaldiskon * ($discount_amount/100);

             echo number_format($vat_nilai,2); ?></td>
          </tr>
          <tr style="border: 1px solid black;">
            ...
            <td width="15%" align="right" style="border: 1px solid black;"><?php 
                        ...
                        $grandtota = $totaldiskon + ($totaldiskon * ($discount_amount/100)); 

                        $grandtotal = $grandtota ; 
         ...
         <!--  <?php if( !empty($total_kualifikasi)){ ?>
          ...
          <tr style="border: 1px solid black;">
            ...
            <td width="15%" align="right" style="border: 1px solid black;font-size: 10px;font-weight: bold;"><?php 
