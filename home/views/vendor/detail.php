...
<div class="modal-body">
    ...
    <div class="col-sm-12">
        <ul id="tab-menu" class="nav nav-tabs">
            ...
            <li>
                <a href="#tab7" data-toggle="tab">Dok Qhse</a>
            </li>
             <li>
                <a href="#tab6" data-toggle="tab">Dok Finance</a>
            </li>
             <li>
                <a href="#tab2" data-toggle="tab">Dok Legal</a>
            </li>
             <li>
                <a href="#tab8" data-toggle="tab">Dok Others</a>
            </li>
           <!--  <li>
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped">
                        <tbody>
                                ...
                                <td colspan="3">
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            <tbody>
                                                <tr>
                                                    <td class="col-md-3">Nama Dokumen</td>
                                                    <td>File</td>
                                                </tr>
                                                       <?php
                                                        if (!empty($decode_dokumen_legal)) {
                                                            foreach ($decode_dokumen_legal as $row_dok) {
                            ...
                            <tr>
                                <td class="col-md-3"><b>Akte Notaris</b></td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>File</td>
                                                       ...
                                                       <?php
                                                        if (!empty($decode_dokumen_finance)) {
                                                            foreach ($decode_dokumen_finance as $row_dok) {
                                                                $deskripsi = $row_dok['deskripsi'];
                                                                $file = $row_dok['file'];
                                                                $filename = $row_dok['filename'];
                                                                ?>                                                
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>File</td>
                                                       ...
                                                       <?php
                                                        if (!empty($decode_dokumen_others)) {
                                                            foreach ($decode_dokumen_others as $row_dok) {
                                                                $deskripsi = $row_dok['deskripsi'];
                                                                $file = $row_dok['file'];
                                                                $filename = $row_dok['filename'];
                                                                ?>                                                
